class PersonPresenter < ContentItemPresenter
  ...
  def contents
    [
      {
        text: I18n.t("formats.person.biography"),
        href: "#biography",
      },
      content_item.currently_in_a_role? ? {
        text: I18n.t("formats.person.role_heading", count: content_item.current_roles.count),
        href: "#current-roles",
      } : nil,
      content_item.has_previous_non_ministerial_roles? ? {
        text: I18n.t("formats.person.previous_roles"),
        href: "#previous-roles",
      } : nil,
      announcements.items.present? ? {
